...
export const MESSAGES = {
  ...
  SUCCESS: {
    ...
    RATING_CREATED: 'Rating evaluation created successfully.',
    RATING_UPDATED: 'Rating evaluation updated successfully.',
    RATING_DELETED: 'Rating evaluation deleted successfully.',
    RATING_SUBMITTED: 'Your feedback was submitted successfully.',
