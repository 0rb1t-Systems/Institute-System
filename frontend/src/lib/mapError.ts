...
const CODE_MAP = {
  ...
  EMAIL_NOT_CONFIGURED: {
    ...
    description: MESSAGES.AUTH.EMAIL_NOT_CONFIGURED,
  },
  ...
  'AUTH.PLATFORM_ADMIN_ONLY': MESSAGES.AUTH.PLATFORM_ADMIN_ONLY,
  AUTH_PLATFORM_ADMIN_ONLY: MESSAGES.AUTH.PLATFORM_ADMIN_ONLY,
  'AUTH.WRONG_INSTITUTION': MESSAGES.AUTH.WRONG_INSTITUTION,
  AUTH_WRONG_INSTITUTION: MESSAGES.AUTH.WRONG_INSTITUTION,
  'AUTH.SUPER_ADMIN_PLATFORM_ONLY': MESSAGES.AUTH.SUPER_ADMIN_PLATFORM_ONLY,
  AUTH_SUPER_ADMIN_PLATFORM_ONLY: MESSAGES.AUTH.SUPER_ADMIN_PLATFORM_ONLY,
  ...
  INVALID_STUDENT_ID_SAMPLE: {
    ...
    description: 'Use at least 3 characters: letters plus a number (HC0, BRCE12) or digits only (134).',
  },
  STUDENT_ID_REQUIRED: {
  ...
  STUDENT_ID_TOO_SHORT: {
    ...
    description: 'Student IDs must be at least 3 characters (for example HC0). First password is the same as the ID.',
  },
