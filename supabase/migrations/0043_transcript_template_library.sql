-- =====================================================================
--  0043_transcript_template_library.sql
--  Active transcript layout selection (built-in library keys).
--  Does not alter certificate/invoice templates.
-- =====================================================================
...
-- Normalize legacy transcript layout_key 'default' → 'classic'
update public.document_templates
